...
if(WITHOUT_GIT)
  set(rev_date "2023-01-01 00:00:00 +0700")
  set(rev_hash "84b285633alg")
  set(rev_branch "AzgathCoreLegion")
else()
  if(GIT_EXECUTABLE)
  ...
  if(NOT rev_info)
    ...
    Continuing anyway - note that the versionstring will be set to \"84b285633alg 2023-01-01 00:00:00 (AzgathCoreLegion)\"")
    set(rev_date "2023-01-01 00:00:00 +0700")
    set(rev_hash "84b285633alg")
    set(rev_branch "AzgathCoreLegion")
  else()
