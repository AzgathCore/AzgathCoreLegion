...
MySQL - 10.5.8-MariaDB : Database - azl_auth
*********************************************************************
*/
...
(1,'Az\'gathCore 7.3.5','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,2,8,0,0,26972,1,1);
...
('$/sql/legion/updates/auth','RELEASED');
...
CREATE TABLE `uptime` (
  ...
  `revision` varchar(255) NOT NULL DEFAULT 'AzgathCore',
...
(1,1583089869,0,0,'AzgathCore rev. 896d2c6ddc51 2020-03-01 12:08:25 +0300 (legion branch) (Win64, Release, Static)'),
(1,1583093836,0,0,'AzgathCore rev. 896d2c6ddc51 2020-03-01 12:08:25 +0300 (legion branch) (Win64, Release, Static)'),
(1,1633228529,0,0,'AzgathCore rev. unknown 1970-01-01 00:00:00 +0000 (Archived branch) (Win64, Release, Static)');
